...
public class Principal {
	...
	public static void main(String[] args) {
		...
		PerformKenkenPuzzle("\\src\\puzzle\\kenken1.txt", SearchType.BFS);
		PerformKenkenPuzzle("\\src\\puzzle\\kenken1.txt", SearchType.DFS);
		
		PerformKenkenPuzzle("\\src\\puzzle\\kenken2.txt", SearchType.BFS);
		PerformKenkenPuzzle("\\src\\puzzle\\kenken2.txt", SearchType.DFS);
		
		PerformKenkenPuzzle("\\src\\puzzle\\kenken3.txt", SearchType.BFS);
		PerformKenkenPuzzle("\\src\\puzzle\\kenken3.txt", SearchType.DFS);
		
		PerformKenkenPuzzle("\\src\\puzzle\\kenken4.txt", SearchType.BFS);
		PerformKenkenPuzzle("\\src\\puzzle\\kenken4.txt", SearchType.DFS);
		
		PerformKenkenPuzzle("\\src\\puzzle\\kenken5.txt", SearchType.BFS);
		PerformKenkenPuzzle("\\src\\puzzle\\kenken5.txt", SearchType.DFS);
